...
void lcd_display(){
	Lcd_cursor(&lcd, 0, 1);
	Lcd_string(&lcd, "Aaron I \n");
	Lcd_cursor(&lcd, 1, 1);
	Lcd_string(&lcd, "212223230002 \n");
...
## Output screen shots of proteus  :
 ...
 ![PMCP](https://github.com/user-attachments/assets/826c9a13-903b-428f-8375-125db42d0b93)

 ![Screenshot 2024-09-23 141218](https://github.com/user-attachments/assets/40ce02a7-ef64-4625-b788-9cd34c5e6f95)

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![Screenshot 2024-09-23 141254](https://github.com/user-attachments/assets/04a6da03-aed7-438d-8450-097e9938c716)
